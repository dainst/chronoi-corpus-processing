...
# while read -r line; do python3 translate_by_idai_vocab.py "$line"; done < /srv/output/heideltime_temponym_files/en_repattern.txt > /srv/output/temponym-translations/translate_en_idai_vocab.txt
