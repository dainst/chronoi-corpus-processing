...
# docker exec -it chronoi-pilot python3 postprocessing/prepare_tempeval.py --no-fake-dct "${dir_bronze}/en/*_DONE.xml" "${dir_eval}/bronze"
# docker exec -it chronoi-pilot python3 postprocessing/prepare_tempeval.py --no-fake-dct "${dir_system}/en/*.xml" "${dir_eval}/system"
